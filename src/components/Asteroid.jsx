...
const Asteroid = () => {
	...
	useEffect(() => {
		fetch(
			`https://api.nasa.gov/neo/rest/v1/feed?start_date=${selectedDate}&api_key=${apiKey}`
		)
			...
			.then((data) => {
				...
				const allAsteroids = allDates.flatMap(
					(date) => data.near_earth_objects[date]
				)
				...
				<div className="flex flex-col items-center mb-8 space-y-4">
					...
					<div className="bg-gray-800 p-6 rounded-lg mb-8">
						...
						<p className="text-gray-300 mb-2">
							NeoWs (Near Earth Object
							Web Service) is a
							RESTful web service for
							near earth Asteroid
							information. With NeoWs,
							you can search for
							Asteroids based on their
							closest approach date to
							Earth, lookup a specific
							Asteroid with its NASA
							JPL small body id, as
							well as browse the
							overall data-set.
						</p>
						<p className="text-gray-300 mb-2">
							All the data is from the
							NASA JPL Asteroid team (
							<a
								href="http://neo.jpl.nasa.gov/"
